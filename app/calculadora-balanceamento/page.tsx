...
export default function CalculadoraBalanceamento() {
  ...
  const handleCalculate = () => {
    ...
    // Navegar para a tela de recomendações BTG (etapa opcional)
    router.push(`/calculadora-balanceamento/recomendacoes?valor=${value}`)
  }
    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col">
        ...
        <div className="flex-1 px-4 py-8 flex flex-col">
          ...
          <button className="bg-gray-400 text-white py-4 rounded-lg text-xl font-medium" onClick={handleCalculate}>
            Calcular
          </button>
        </div>
      </div>
