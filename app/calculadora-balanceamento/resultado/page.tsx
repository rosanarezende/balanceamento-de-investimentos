          ...
          <div className="p-4">
            ...
            {loading ? (
              ...
              <div className="bg-yellow-50 p-4 rounded-lg mb-6">
                <h3 className="font-bold text-center mb-2">Nenhum ativo elegível para aporte</h3>
                    ...
                    >
                      <div className="p-3">
                        ...
                        <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-xs">
                          ...
                          <div className="text-gray-500">QTD ATUAL</div>
                          <div className="text-gray-500">QTD A ADQUIRIR</div>
