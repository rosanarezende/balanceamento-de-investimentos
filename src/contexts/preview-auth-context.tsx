...
/**
 * Contexto de autenticação para ambiente de preview
 * 
 * Este contexto fornece uma simulação de autenticação para ambientes
 * de preview ou desenvolvimento, sem depender do Firebase.
 */
